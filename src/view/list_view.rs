...
pub struct ListView<S, E: AsKeyEvent> {
    stack_panel: StackPanel<E>,
    phantom: std::marker::PhantomData<S>,
}

impl<S, E: AsKeyEvent> ListView<S, E> {
...
impl<S, E: AsKeyEvent> View for ListView<S, E> {
    type Event = E;
...
pub fn make_list_view<E: AsKeyEvent, S: Into<Box<dyn View<Event = E>>>>(
